...
export function Navbar3() {
    ...
    return (
        <div className="w-full">
            {/* Visibility wrapper - owns fixed positioning, centering, and hide/show transition */}
            <div
                className="fixed top-0 left-0 right-0 z-[100] flex justify-center pointer-events-none transition-transform duration-300"
                style={{ transform: (isVisible || isOpen) ? 'translateY(0)' : 'translateY(-200%)' }}
            >
                ...
                <motion.nav
                    ...
                    className={cn(
                        "mt-6 md:mt-12 pointer-events-auto w-[92%] overflow-hidden border-gray-thin bg-white/90 backdrop-blur-xl",
                        isOpen
