 ...
 */
const SETTINGS = {
    text: "Velocity Scroll • Basebox • Design System",
    baseVelocity: 5,
};
...
/**
 * ScrollBasedStats Export Component
 */
export function StatsSection2() {
    return (
        <section className="w-full bg-white flex flex-col items-center justify-center overflow-hidden py-24 debug-border">
            <ScrollVelocityContainer className="flex flex-col gap-8 tracking-tighter">
                <ScrollVelocityRow
                    baseVelocity={SETTINGS.baseVelocity}
                    direction={1}
                    style={{
